...
export const ConversationList: React.FC<ConversationListProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white border-r border-slate-200/90 w-full md:w-80 lg:w-96 shrink-0">
      {/* Header */}
      <div className="p-4 border-b border-slate-100 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="p-2 rounded-xl text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 transition-colors border border-slate-200/80 shadow-2xs"
      ...
      <div className="p-3 border-b border-slate-100">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-slate-50 hover:bg-slate-100/80 focus:bg-white text-[13.5px] text-slate-800 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-normal placeholder:text-slate-400"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-slate-50">
        {isLoading ? (
          ...
          <div className="p-8 text-center text-slate-400 text-[13.5px]">
            <p className="font-normal text-slate-600">Belum ada percakapan</p>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <p className="text-[12.5px] text-slate-500 truncate font-normal">
                      {c.last_message ? (
                        <>
