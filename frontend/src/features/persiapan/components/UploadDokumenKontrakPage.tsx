      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 bg-transparent">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
          ...
          <div className="bg-[#fef2f2] border border-[#fee2e2] rounded-2xl px-5 py-3.5 flex items-center gap-3.5 min-w-[175px]">
            ...
            <div>
              <div className="text-[11px] font-bold text-[#ef4444] tracking-wider uppercase">BELUM UPLOAD</div>
              <div className="text-2xl font-normal text-slate-900 leading-tight my-0.5">{belumUploadCount}</div>
          ...
          <div className="bg-[#f0fdf4] border border-[#dcfce7] rounded-2xl px-5 py-3.5 flex items-center gap-3.5 min-w-[175px]">
            ...
            <div>
              <div className="text-[11px] font-bold text-[#16a34a] tracking-wider uppercase">UPLOAD</div>
              <div className="text-2xl font-normal text-slate-900 leading-tight my-0.5">{uploadedCount}</div>
              <div className="text-xs font-semibold text-[#16a34a]">{uploadedCount} Required</div>
            </div>
          </div>
          ...
          <div className="bg-[#f0f9ff] border border-[#e0f2fe] rounded-2xl px-5 py-3.5 flex items-center gap-3.5 min-w-[175px]">
            ...
            <div>
              <div className="text-[11px] font-bold text-[#0284c7] tracking-wider uppercase">TERVERIFIKASI</div>
              <div className="text-2xl font-normal text-slate-900 leading-tight my-0.5">{verifiedCount}</div>
          ...
          <div className="bg-[#fefce8] border border-[#fef9c3] rounded-2xl px-5 py-3.5 flex items-center gap-3.5 min-w-[175px]">
            ...
            <div>
              <div className="text-[11px] font-bold text-[#ca8a04] tracking-wider uppercase">BELUM VERIF.</div>
              <div className="text-2xl font-normal text-slate-900 leading-tight my-0.5">{belumVerifCount}</div>
