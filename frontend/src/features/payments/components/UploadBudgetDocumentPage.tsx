  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      showAlert({
        ...
        message: "Berkas dokumen anggaran berhasil diunggah.",
        type: "success",
      });
    },
    onError: (err: any) => {
  ...
  const handleAddCustomDoc = async (e: React.FormEvent) => {
    ...
    if (customUploadFile) {
      ...
      try {
        ...
        showAlert({
          title: "Berhasil Diunggah",
          message: "Dokumen anggaran berhasil diunggah.",
          type: "success",
        });
      } catch (err: any) {
        showAlert({
                            ...
                            <button
                              ...
                              onClick={() => {
                                showConfirm({
                                  ...
                                  message: "Apakah Anda yakin ingin menghapus file dokumen pembayaran ini?",
                                  confirmText: "Hapus",
                                  isDestructive: true,
